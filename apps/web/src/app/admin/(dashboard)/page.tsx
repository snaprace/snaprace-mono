...
import { Trophy, Users, Calendar, Image as ImageIcon } from "lucide-react";
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-muted-foreground">Welcome back to your SnapRace organizer console.</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">+5.2k this week</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        ...
        <Card className="lg:col-span-3">
          ...
          <CardContent>
            <div className="space-y-4">
              <p className="text-sm text-muted-foreground italic">Event analysis coming soon...</p>
            </div>
          </CardContent>
        </Card>
      </div>
