...
async function processMessage(message: SQSRecord, env: IndexFacesEnvironment): Promise<void> {
  ...
  console.log(`Successfully indexed faces for ${sanitized_key}. Faces: ${faceIds.length}, Bib: ${finalBibNumber}`)
}
...
export const handler = async (event: SQSEvent, context: Context): Promise<void> => {
  ...
  // 환경 변수 검증
  if (!env.PHOTOS_TABLE_NAME || !env.PHOTO_FACES_TABLE_NAME || !env.PHOTOS_BUCKET_NAME) {
